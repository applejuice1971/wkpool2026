...
$stmt = $pdo->prepare('INSERT INTO matches (external_id, stage, match_date, home_team, away_team, status) VALUES (:external_id, :stage, :match_date, :home_team, :away_team, :status)');
